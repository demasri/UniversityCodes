...
create or replace function releve (@matricule char(10), @prog char(7)) returns table
 (trimc char(5), sigle char(10), titre varchar(45),  credits numeric, note char(3)) as $$
   ...
   CAST('Moy' as char(10)) as sigle,
    ...
    REQ3 AS
	  ...
	  CAST('Moyenne cumulative' as varchar(45))  AS titre,
	    ...
	    left join MOYENNE_PAR_TRIM mpt on (mpt.trimc = n.trimc)
	    WHERE n.matricule = matricule AND n.prog = prog
