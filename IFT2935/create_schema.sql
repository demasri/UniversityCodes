create schema ift2935_projet_test3;

set search_path to ift2935_projet_test3;
...
CREATE TABLE Annonceur (
  Id_Annonceur int NOT NULL GENERATED AS IDENTITY,
...
CREATE TABLE Catégorie (
  Id_Catégorie int NOT NULL GENERATED AS IDENTITY,
...
CREATE TABLE Client (
  Id_Client int NOT NULL GENERATED AS IDENTITY,
    Nom varchar(255) NOT NULL,
...
CREATE TABLE Expert (
  Id_Expert int NOT NULL GENERATED AS IDENTITY,
    Nom varchar(255) NOT NULL,
      Prénom varchar(255) NOT NULL,
...
CREATE TABLE Produit (
  Id_Produit int NOT NULL GENERATED AS IDENTITY,
